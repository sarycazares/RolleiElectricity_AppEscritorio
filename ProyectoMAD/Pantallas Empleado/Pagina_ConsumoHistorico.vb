...
Public Class Pagina_ConsumoHistorico
    ...
    Private Sub Pagina_ConsumoHistorico_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles Button4.Click
        ...
        Try
            ...
            Dim ds As DataSet = New DataSet()
            Dim adaptador As SqlDataAdapter = New SqlDataAdapter
            adaptador = New SqlDataAdapter("mostrar_historico_periodo", cn)
            Dim cliente_encontrado As Boolean = False
            ...
            adaptador.SelectCommand.CommandType = CommandType.StoredProcedure
            adaptador.SelectCommand.Parameters.Add("@periodo", SqlDbType.VarChar, 30).Value = numero_buscado
            adaptador.Fill(ds, "recibo")
    ...
    Private Sub Button5_Click(sender As Object, e As EventArgs) Handles Button5.Click
        ...
        Try
            ...
            Dim numero_buscado As String = ComboBox2.Text
