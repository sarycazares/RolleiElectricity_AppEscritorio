...
Public Class Pagina_DesbloquearCliente
    Private Sub Pagina_DesbloquearCliente_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        Try
            ...
            cn.Open()
            Dim comando As SqlCommand = New SqlCommand("desbloquear_c", cn)
    ...
    Private Sub Pagina_DesbloquearCliente_FormClosing(ByVal sender As System.Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles MyBase.FormClosing
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        Try
            ...
            adaptador = New SqlDataAdapter("buscardesbloquear_c", cn)
            Dim cliente_encontrado As Boolean = False

            adaptador.SelectCommand.CommandType = CommandType.StoredProcedure

            adaptador.SelectCommand.Parameters.Add("@nom_usuario", SqlDbType.VarChar, 30).Value = nombre_buscado
